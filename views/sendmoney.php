<main role="main" class="container my-5">
    ...
    <form class="form-inline" action="actions.php" method="post">
        ...
        <input type="number" class="form-control mb-2 mr-sm-2 mb-sm-0" id="inlineFormInputGroup" placeholder="Email or Phone" name="to" required min="0.00" max="99999.99" step="0.01">
        <input type="number" class="form-control mb-2 mr-sm-2 mb-sm-0" id="inlineFormInputGroup" placeholder="Amount" name="amount" required min="0.00" max="99999.99" step="0.01">
