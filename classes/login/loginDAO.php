...
class LoginDAO {
	...
	function __construct() {
		...
		# if local
		$this->connectString = "mysql:host=localhost;dbname=giusqehd_gec353_2;charset=utf8mb4";
		$this->user = "gec353";
		$this->password = "gec353";
	}
    ...
    public function loginUser($cardNumber, $password){
        ...
        try{
            ...
            $stmt = $pdo->prepare("SELECT password, user_id, is_employee FROM login WHERE cardNumber = :cardNumber");
            $stmt->bindValue(':cardNumber', $cardNumber);
